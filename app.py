...
if random.random() < 0.02:
    st.session_state.logs.append("⚠ Suspicious outbound network traffic")
...
with col2:
    ...
    st.markdown(
        f'<div class="status-panel"><h3>🛡 RESILIENCE: <span style="color:{color};">{score}%</span></h3></div>',
        unsafe_allow_html=True
    )
...
app = st.selectbox(
"Select Application",
["📧 Outlook Mail","💬 Teams Chat","🛡 Defender"],
